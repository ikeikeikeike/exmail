defmodule Exmail.UserFromAuth do
  # import Exmail.Gettext

  alias Exmail.User
  alias Exmail.Authorization
  ...
  # XXX: I think that prefers to create table for mailbox when user registers
  #      that joins into exmail, it is like polymorphic association for database's
  #      fetches performance. Currently, works that by the same a table.
  #
