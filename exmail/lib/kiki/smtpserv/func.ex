defmodule Exmail.SMTPServ.Func do
  ...
  def send_mail(sender, recipients, subject, body) do
    ...
    cf = Exmail.smtp_env
    client_options = [relay: host, username: sender, password: "anything", port: cf[:port]]
  ...
  def participant_emails([_|_] = participants, []) do
  ...
  def format_participants([_|_] = participants, []) do
